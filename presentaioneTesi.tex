...
\begin{frame}
 ...
 Si è  simulato una situazione avversariale dove il seedset  utilizzato dagli algoritmi sia formato da nodi al limite del grafo \(G\).
\begin{center}
...
\begin{itemize}
 ...
 \item Il test è simile al esperimento 5 ma invece di usare i valori temporanei di TrustRank e Anti-trust Rank per calcolare \(\Delta_t\) e \(\Delta_a\), durante la visita in ampiezza, si utilizzano i valori ricavati da TrustRank e Anti-trust Rank calcolati sul grafo completo.
 \end{itemize}
\end{frame}
\begin{frame}
